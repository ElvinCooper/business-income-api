...
Este documento establece las directrices técnicas obligatorias para la generación de código y asistencia en este proyecto. Se basa en los estándares de **FastAPI**, **SQLModel**, **Pydantic** y **MySQL**.
